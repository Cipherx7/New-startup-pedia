...
export function DashboardClient({ initialStartups }: DashboardClientProps) {
  ...
  const [startupOpportunities, setStartupOpportunities] = useState(initialStartups);
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {filteredOpportunities.map((opportunity, index) => (
            <Card key={index} className="rounded-lg border border-blue-200 bg-white shadow-md transition hover:shadow-lg">
