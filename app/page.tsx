...
export default function Home() {
  return (
    <div className="flex min-h-screen flex-col bg-white">
      ...
      {/* Hero Section */}
      <section className="container mx-auto grid items-center gap-8 px-4 py-12 sm:grid-cols-1 md:grid-cols-2 md:py-24 bg-blue-50">
      ...
      <section className="container mx-auto px-4 py-16 bg-white">
        <div className="grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          <Card className="transition-all duration-300 hover:shadow-lg hover:-translate-y-1 bg-white border-blue-100">
            <CardContent className="flex flex-col items-start gap-4 p-6">
              <div className="rounded-lg bg-blue-100 p-3">
                <Rocket className="h-6 w-6 text-blue-600" />
              </div>
              <h3 className="text-xl font-semibold text-blue-900">Post Your Startup</h3>
          ...
          <Card className="transition-all duration-300 hover:shadow-lg hover:-translate-y-1 bg-white border-blue-100">
            <CardContent className="flex flex-col items-start gap-4 p-6">
              ...
              <h3 className="text-xl font-semibold text-blue-900">Find Talent</h3>
              <p className="text-slate-600">
          ...
          <Card className="transition-all duration-300 hover:shadow-lg hover:-translate-y-1 bg-white border-blue-100">
            <CardContent className="flex flex-col items-start gap-4 p-6">
              ...
              <h3 className="text-xl font-semibold text-blue-900">Grow Together</h3>
              <p className="text-slate-600">
